...
export default defineConfig({
  testDir: './e2e',
  /* Tests share mutable API/DB state; keep in-file execution deterministic. */
  fullyParallel: false,
  ...
  webServer: [
    {
      command: 'cd ..\\backend && ..\\.venv\\Scripts\\python.exe -m uvicorn main:app --reload --host 0.0.0.0 --port 8000',
